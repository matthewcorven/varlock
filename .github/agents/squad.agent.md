...
```
Premium:  gpt-5.4 → claude-opus-4.6 → claude-opus-4.6-fast → claude-opus-4.5 → claude-sonnet-4.5 → (omit model param)
...
🎨 Redfoot (gpt-5.4 · vision) — designing color system
...
Premium: `gpt-5.4`, `claude-opus-4.6`, `claude-opus-4.6-fast`, `claude-opus-4.5`
