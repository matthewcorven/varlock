...
- 2026-03-17: For overhaul-scale autonomous work before issues exist, Ralph should define stable node IDs, a permanent proof/docs sync lane, and green/yellow/red thresholds before more fan-out begins; otherwise the board tracks motion instead of phase-gate readiness.
